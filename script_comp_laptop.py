...
folder_csv="comp_laptop_csv"
folder_graphs="comp_laptop"
...
a_devices_df.loc[:,"a4_comp"]=a_devices_df["a4_comp"] | a_devices_df["a4_laptop"]
a_devices_df = a_devices_df.rename(columns= {"a1_gender":"gender", "a4_mobile":"Mobile phone","a4_game":"Game Console",
                                             "a4_comp":"Computer/Laptop","a4_tablet":"Tablet"})
a_devices_df = a_devices_df.drop(columns="a4_laptop")
